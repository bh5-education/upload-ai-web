        ...
        <aside className='w-80 space-y-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              />
              <span className='block text-xs text-muted-foreground italic leading-relaxed'>Valores mais altos tendem a deixar o resultado mais criativo e com mais erros</span>
            </div>
